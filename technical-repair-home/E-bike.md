...
https://api.magura.com/medias/sys_master/maguracom-medias/h4c/hd0/9603888545822/hs_manual_2017_en/hs-manual-2017-en.pdf

проблема с переключениями передач снова.
...
Это поможет понять источник:
* только под нагрузкой?
* или даже на вывешенном колесе?
* только вверх?
* только вниз?
* только на 7–8?
* есть ли проблема на 1–2?
